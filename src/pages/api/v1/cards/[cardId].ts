...
import { deleteCard } from "@/lib/services/cards.service";
import type { DeleteCardInput, DeleteCardPathParamsDto } from "@/types";

export const prerender = false;

const deleteCardPathParamsSchema = z.object({
...
export const DELETE: APIRoute = async ({ params, request, locals }) => {
  ...
  const parsedParams = deleteCardPathParamsSchema.safeParse(params);
